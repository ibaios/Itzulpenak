...
AppId={{DA799985-88C3-4B8A-9F15-7CB0F71302DD}
AppName={#MyAppName}
...
[Files]
Source: "..\webbed-eu-es.csv"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\webbed-eu-fr.csv"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{cmd}"; Parameters: "/C move ""{app}\webbed-eu-{code:GetSelectedLanguage}.csv"" ""{code:GetSelectedGameDataDir}\translations.csv"""
