...
wget https://ibaios.eus/itzulpenak/hollowknight/hollow-knight-eu-fr.emip

echo "Deskargatuta."
echo "Itzulpena aplikatzen..."

# Aplikatu itzulpena
export DOTNET_ROOT=~/.dotnet/ && uabea/net5.0/UABEAvalonia applyemip hollow-knight-eu-fr.emip ~/.steam/steam/steamapps/common/Hollow\ Knight/hollow_knight_Data/
